...
abstract class SimpleInputFormatter {
  static FilteringTextInputFormatter get filterDouble => FilteringTextInputFormatter.allow(RegExp(r'^\d+\.?(\d+)?'));
  static FilteringTextInputFormatter get filterInt => FilteringTextInputFormatter.allow(RegExp(r'\d+'));
}
